  ...
  return (
    <div>
                ...
                <TableRow key={ex?.id} hover>
                  ...
                  <TableCell align="center">
                    <Button
                      variant="contained"
                      size="small"
                      sx={{ mr: 1, minWidth: 36, padding: "4px" }}
                      onClick={() => handleModalOpen(ex)}
                    >
                    ...
                    <Button
                      ...
                      size="small"
                      color="error"
                      sx={{ minWidth: 36, padding: "4px" }}
                      onClick={() => handleOpen(ex.id)}
                    >
      ...
      <ComanModal
        open={modalOpen}
        onClose={onClose}
        children={<ExpenseForm formData={formData} setFormData={setFormData} errors={errors} setErrors={setErrors} />}
...
export const validateForm = (expense) => {
  ...
  if (!expense_type) {
    error.expense_typeErr = "Expense type is required";
    isValid = false;
  }

  if (amount === null || amount === undefined || amount === "") {
    error.amountErr = "Amount is required!";
    isValid = false;
  } else if (amount < 0) {
    error.amountErr = "Amount should be positive!";
    isValid = false;
  }
